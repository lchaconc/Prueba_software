...
function renderMainAdmin() {
    $("#page-top").html(HtmlMainContentAdmin);
    $("#page-top").append(htmlWraper);

}


function renderMainAsist() {
    $("#page-top").html(HtmlMainContentAsistente);
    $("#page-top").append(htmlWraper);
